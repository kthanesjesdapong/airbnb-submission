...
import {
  BusinessLayout,
  businessLayoutConfigs,
} from '@widgets/business-layout';
...
const BusinessCards = lazy(() =>
  import('@widgets/business-cards/index.js').then((module) => ({
    default: module.BusinessCards,
  }))
);
  ...
  return (
    <>
      ...
      >
        <h1
          style={{
            textAlign: currentWidth >= 1024 ? 'start' : 'center',
            marginBottom: '0',
          }}
        >
          {'B A R S'}
