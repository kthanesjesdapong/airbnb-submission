...
const ExplorePage = lazy(() =>
  import('@pages/explore/index.js').then((module) => ({
    default: module.ExplorePage,
  }))
);

const EventsPage = lazy(() =>
  import('@pages/events/index.js').then((module) => ({
    default: module.EventsPage,
  }))
);

const RestaurantsPage = lazy(() =>
  import('@pages/restaurants/index.js').then((module) => ({
    default: module.RestaurantsPage,
  }))
);

const BarsPage = lazy(() =>
  import('@pages/bars/index.js').then((module) => ({
    default: module.BarsPage,
  }))
);
  ...
  return (
    <Routes>
      <Route>
        ...
        />
        <Route
          path="explore/restaurants/:model/:restaurantId"
